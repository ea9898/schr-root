...
public class SchedulerConfiguration implements SchedulingConfigurer {
    ...
    public void configureTasks(ScheduledTaskRegistrar taskRegistrar) {
        ...
        addSchoolAttachmentEventProcessTask(taskRegistrar);
    }

    private void addSchoolAttachmentEventProcessTask(ScheduledTaskRegistrar taskRegistrar) {
        taskRegistrar.addFixedDelayTask(new IntervalTask(schoolAttachmentEventProcessTask::runTask, Duration.ofMillis(60000), Duration.ofMillis(10000)));
    }
