package moscow.ptnl.app.esu.sae.listener.validator;
...
@Component
public class ErpChangePatientSchoolBaseValidator {

    private static final Logger LOG = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass().getName());

    private static final String SCHEMA_PATH = "json.schema/ErpChangePatientSchoolBase.json";

    private final Schema schema;

    public ErpChangePatientSchoolBaseValidator() {
