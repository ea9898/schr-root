...
public class SchedulerConfiguration implements SchedulingConfigurer {
    ...
    @Autowired
    private LastAnthropometryProcessTask lastAnthropometryProcessTask;
    ...
    private void addLastAnthropometryProcessTask(ScheduledTaskRegistrar taskRegistrar) {
        taskRegistrar.addFixedDelayTask(new IntervalTask(lastAnthropometryProcessTask::runTask, Duration.ofMillis(60000), Duration.ofMillis(10000)));
    }
