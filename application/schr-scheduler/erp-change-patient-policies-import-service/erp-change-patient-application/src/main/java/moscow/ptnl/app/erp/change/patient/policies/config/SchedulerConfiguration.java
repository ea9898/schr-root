...
public class SchedulerConfiguration implements SchedulingConfigurer {
    ...
    public void configureTasks(ScheduledTaskRegistrar taskRegistrar) {
        ...
        addErpChangePatientPoliciesProcessTask(taskRegistrar);
    }

    private void addErpChangePatientPoliciesProcessTask(ScheduledTaskRegistrar taskRegistrar) {
        taskRegistrar.addFixedDelayTask(new IntervalTask(erpChangePatientPoliciesProcessTask::runTask, Duration.ofMillis(60000), Duration.ofMillis(10000)));
    }
