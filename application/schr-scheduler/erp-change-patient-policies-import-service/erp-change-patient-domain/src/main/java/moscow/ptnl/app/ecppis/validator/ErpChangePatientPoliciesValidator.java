...
@Component
public class ErpChangePatientPoliciesValidator {

    private static final Logger LOG = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass().getName());

    private static final String SCHEMA_PATH = "json.schema/ErpChangePatientPolicies.json";

    private final Schema schema;

    public ErpChangePatientPoliciesValidator() {
