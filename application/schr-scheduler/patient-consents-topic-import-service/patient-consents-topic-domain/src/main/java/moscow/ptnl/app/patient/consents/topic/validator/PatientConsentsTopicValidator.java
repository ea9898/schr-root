package moscow.ptnl.app.patient.consents.topic.validator;
...
@Component
public class PatientConsentsTopicValidator {

    private static final Logger LOG = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass().getName());

    private static final String SCHEMA_PATH = "json.schema/PatientConsentsTopic.json";

    private final Schema schema;

    public PatientConsentsTopicValidator() {
