package moscow.ptnl.app.esu.ecppd.listener.validator;
...
@Component
public class ErpChangePatientBaseValidator {

    private static final Logger LOG = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass().getName());

    private static final String SCHEMA_PATH = "json.schema/ErpChangePatientBase.json";

    private final Schema schema;

    public ErpChangePatientBaseValidator() {
